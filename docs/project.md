...
The project is hosted on [https://github.com/whiteprints-tests/test-codecov-linux-py312-test.git](https://github.com/whiteprints-tests/test-codecov-linux-py312-test.git).
